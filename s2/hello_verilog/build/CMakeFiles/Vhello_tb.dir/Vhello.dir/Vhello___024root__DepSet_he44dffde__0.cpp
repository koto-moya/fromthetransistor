...
VL_INLINE_OPT void Vhello___024root___combo__TOP__0(Vhello___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vhello__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vhello___024root___combo__TOP__0\n"); );
    // Body
...
VL_INLINE_OPT void Vhello___024root___sequent__TOP__0(Vhello___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vhello__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vhello___024root___sequent__TOP__0\n"); );
    // Body
    ++(vlSymsp->__Vcoverage[68]);
    if (vlSelf->__Vcellinp__hello__reset_n_i) {
        ++(vlSymsp->__Vcoverage[67]);
        vlSelf->hello__DOT__data = vlSelf->__Vcellinp__hello__data_i;
    } else {
        vlSelf->hello__DOT__data = 0U;
    }
    if ((1U & (~ (IData)(vlSelf->__Vcellinp__hello__reset_n_i)))) {
...
VL_INLINE_OPT void Vhello___024root___combo__TOP__1(Vhello___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vhello__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vhello___024root___combo__TOP__1\n"); );
    // Body
